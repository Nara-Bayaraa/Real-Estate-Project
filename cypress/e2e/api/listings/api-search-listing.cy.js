...
describe("End-to-End: property listing creation , search created property , and delete created property listing  by ID via API", () => {
  ...
  it.skip("[LISTING-005] should search using all filters together", () => {
    ...
    FeaturedListingsPage.verifyAllResultsIncludeKeyword(ListingData.newRealEstateAPI.title);
    FeaturedListingsPage.verifyAllResultsIncludeBedroom(ListingData.newRealEstateAPI.bedrooms);
    FeaturedListingsPage.verifyAllResultsIncludeCity(ListingData.newRealEstateAPI.city);
    FeaturedListingsPage.verifyAllResultsIncludeState(ListingData.newRealEstateAPI.state);
  });
