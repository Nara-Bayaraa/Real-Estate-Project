...
describe("Register Page: Realtor Positive Test Cases", () => {
  ...
  it("[REG-REALTOR-POS-001] should register as a realtor when the checkbox is checked and display a welcome message", () => {
  ...
  it("[REG-REALTOR-POS-002] should keep realtor registration option unchecked when the checkbox is not selected", () => {
